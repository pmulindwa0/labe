...
<head>
    ...
    <title>LABE Data Management System</title>
    ...
    <div class="jumbotron jumbotron-fluid" id="banner" style="background-image: url(img/banner-bk.jpg);">
        <div class="container text-center text-md-left">
            ...
            <h1 data-aos="fade" data-aos-easing="linear" data-aos-duration="1000" data-aos-once="true" class="display-3 text-white font-weight-bold my-5">
            	A New Way To Study through Home Learning Centers
            </h1>
            <p data-aos="fade" data-aos-easing="linear" data-aos-duration="1000" data-aos-once="true" class="lead text-white my-4">
                

     Through home learning centers we promote literacy practices, increase access
<br> to and utilisation of information particularly for women and chldren in local
<br> communities to effectively demand and protect their individual and wider
<br> community rights
        ...
        <div class="container my-5">
            <div class="row justify-content-between">
                <div class="col-md-6 text-white">
                    ...
                    <p class="my-4">
                        Reach out to us on anything concerning explanations,
                        <br> on any of our research in any of our projects.
                    </p>
                    <ul class="list-unstyled">
                        <li>Phone : +256-41-4532116</li>
                         <li>Mobile : +256-77-2181998</li>
                         <li>Email :  labe@labeuganda.org</li>
                         <li>Website :  <a href="www.labeuganda.org"> www.labeuganda.org </a> </li>
                        <li>Address : Plot 11 Martyrs Crescent,  Ntinda, Uganda</li>
                    </ul>
                </div>
                <div class="col-md-6">
                    <form>
